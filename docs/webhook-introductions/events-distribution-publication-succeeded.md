The `EVENTS.DISTRIBUTION.PUBLICATION.SUCCEEDED` event indicates that a voucher code was successfully published to a customer through a distribution channel.
