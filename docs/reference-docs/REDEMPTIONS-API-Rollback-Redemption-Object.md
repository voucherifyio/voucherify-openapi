...
1. [Redemption Rollback Base](#redemption-rollback-base)
...
| created_at</br>`string` | <p>Timestamp representing the date and time when the redemption rollback was created in ISO 8601 format.</p> **Example:** <p>2021-12-22T10:13:06.487Z</p> |
| tracking_id</br>`string` | <p>Hashed customer source ID.</p> |
| metadata</br>`object` | <p>The metadata object stores all custom attributes assigned to the redemption rollback.</p> |
...
| related_object_id</br>`string` | <p>Unique related object ID assigned by Voucherify.</p> |
| related_object_parent_id</br>`string` | <p>Unique related parent object ID assigned by Voucherify.</p> |
