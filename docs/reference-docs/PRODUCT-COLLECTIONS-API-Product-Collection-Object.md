...
| type</br>`string` | <p>Describes whether the product collection is dynamic (products come in and leave based on set criteria) or static (manually selected products). The value is <code>STATIC</code> or <code>AUTO_UPDATE</code>.</p> |
