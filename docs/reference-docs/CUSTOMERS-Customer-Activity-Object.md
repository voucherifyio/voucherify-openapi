...
| application_details</br>`array` | Array of: <table><thead><tr><th style="text-align:left">Attributes</th><th style="text-align:left">Description</th></tr></thead><tbody><tr><td style="text-align:left">source_index</br><code>integer</code></td><td style="text-align:left"></td></tr><tr><td style="text-align:left">source_applied_quantity</br><code>integer</code></td><td style="text-align:left"></td></tr><tr><td style="text-align:left">source_applied_quantity_amount</br><code>integer</code></td><td style="text-align:left"></td></tr><tr><td style="text-align:left">target_index</br><code>integer</code></td><td style="text-align:left"></td></tr><tr><td style="text-align:left">target_applied_quantity</br><code>integer</code></td><td style="text-align:left"></td></tr><tr><td style="text-align:left">target_applied_quantity_amount</br><code>integer</code></td><td style="text-align:left"></td></tr><tr><td style="text-align:left">target_applied_discount_amount</br><code>integer</code></td><td style="text-align:left"></td></tr></tbody></table> |
