...
| campaign_name</br>`string` | <p>Campaign name. Displayed only if the <code>options.redeemable</code> is passed in the validation request body.</p> |
| campaign_id</br>`string` | <p>Unique campaign ID assigned by Voucherify. Displayed only if the <code>options.redeemable</code> is passed in the validation request body.</p> **Example:** <p>camp_pqZjuhG6Mgtp4GD0zD7b8hA3</p> |
| name</br>`string` | <p>Name of the promotion tier. Displayed only if the <code>options.redeemable</code> is passed in the validation request body.</p> |
