...
## VOUCHERS.BULK_ENABLE
| Attributes |  Description |
|:-----|:--------|
| message</br>`string` | <p>A human-readable message with the number of enabled vouchers.</p> **Example:** <p>Enabled 1999 vouchers.</p> |
| done_count</br>`integer` | <p>Represents the number of enabled vouchers.</p> |
