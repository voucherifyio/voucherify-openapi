...
| redemption | See: [Redemption](#redemption) |
...
| voucher | See: [Simple Voucher](#simple-voucher) |
| campaign | See: [Simple Campaign](#simple-campaign) |
| loyalty_tier | See: [LoyaltyTier](#loyaltytier) |
...
2. <h3>Loyalty Tier Upgraded</h3><table><thead><tr><th style="text-align:left">Attributes</th><th style="text-align:left">Description</th></tr></thead><tbody><tr><td style="text-align:left">loyalty_tier_from</td><td style="text-align:left">See: <a href="#loyaltytier">LoyaltyTier</a></td></tr><tr><td style="text-align:left">loyalty_tier_to</td><td style="text-align:left">See: <a href="#loyaltytier">LoyaltyTier</a></td></tr><tr><td style="text-align:left">created_at</br><code>string</code></td><td style="text-align:left"><strong>Example:</strong> <p>2022-02-25T13:32:08.734Z</p></td></tr></tbody></table>
...
1. [Event Customer Loyalty Tier Base](#event-customer-loyalty-tier-base)
2. <h3>Loyalty Tier Prolonged</h3><table><thead><tr><th style="text-align:left">Attributes</th><th style="text-align:left">Description</th></tr></thead><tbody><tr><td style="text-align:left">loyalty_tier</td><td style="text-align:left">See: <a href="#loyaltytier">LoyaltyTier</a></td></tr><tr><td style="text-align:left">created_at</br><code>string</code></td><td style="text-align:left"><strong>Example:</strong> <p>2022-02-25T13:32:08.734Z</p></td></tr></tbody></table>
...
| customer</br>`object` | <p>A simple customer object</p> See: [Customer Object](#customer-object) |
...
| sent_at</br>`string` | <p>Timestamp representing the date and time when the sms was sent in ISO 8601 format.</p> **Example:** <p>2021-12-22T10:13:06.487Z</p> |
...
| customer | See: [Simple Customer](#simple-customer) |
| distribution</br>`object` |  |
| recovered_at</br>`string` | <p>Timestamp representing the date and time when the sms was recovered in ISO 8601 format.</p> **Example:** <p>2021-12-22T10:13:06.487Z</p> |
...
| customer | See: [Simple Customer](#simple-customer) |
| distribution</br>`object` |  |
| failed_at</br>`string` | <p>Timestamp representing the date and time when the sms failed in ISO 8601 format.</p> **Example:** <p>2021-12-22T10:13:06.487Z</p> |
...
| voucher | <p>Defines of the voucher.</p> See: [Simple Voucher](#simple-voucher) |
| product | <p>Defines of the product.</p> See: [Simple Product](#simple-product) |
| sku | <p>Defines of the sku.</p> See: [Simple Sku](#simple-sku) |
...
2. <table><thead><tr><th style="text-align:left">Attributes</th><th style="text-align:left">Description</th></tr></thead><tbody><tr><td style="text-align:left">validation_rule_id</br><code>string,null</code></td><td style="text-align:left"><p>A unique validation rule identifier assigned by the Voucherify API. The validation rule is verified before points are added to the balance.</p></td></tr><tr><td style="text-align:left">updated_at</br><code>string,null</code></td><td style="text-align:left"><p>Timestamp representing the date and time when the earning rule was last updated in ISO 8601 format.</p></td></tr><tr><td style="text-align:left">active</br><code>boolean</code></td><td style="text-align:left"><p>A flag to toggle the earning rule on or off. You can disable an earning rule even though it's within the active period defined by the start_date and expiration_date of the campaign or the earning rule's own start_date and expiration_date.</p><ul><li><code>true</code> indicates an active earning rule</li><li><code>false</code> indicates an inactive earning rule</li></ul></td></tr></tbody></table>
...
| voucher | <p>Defines the details of the voucher being redeemed.</p> See: [Simple Voucher](#simple-voucher) |
| promotion_tier | See: [Simple Promotion Tier](#simple-promotion-tier) |
...
| loyalty | Any of: [Define fixed amount of points](#define-fixed-amount-of-points), [Calculate points proportionally](#calculate-points-proportionally) |
...
## Simple Loyalty Voucher
| Attributes |  Description |
|:-----|:--------|
| id</br>`string` |  |
| code</br>`string` |  |
| loyalty_card</br>`object` | <table><thead><tr><th style="text-align:left">Attributes</th><th style="text-align:left">Description</th></tr></thead><tbody><tr><td style="text-align:left">points</br><code>string</code></td><td style="text-align:left"></td></tr><tr><td style="text-align:left">balance</br><code>string</code></td><td style="text-align:left"></td></tr><tr><td style="text-align:left">next_expiration_date</br><code>string</code></td><td style="text-align:left"></td></tr><tr><td style="text-align:left">next_expiration_points</br><code>string</code></td><td style="text-align:left"></td></tr></tbody></table> |
| type</br>`string` | Available values: `LOYALTY_CARD` |
| campaign</br>`string` |  |
| campaign_id</br>`string` |  |
| is_referral_code</br>`boolean` |  |
| holder_id</br>`string` |  |
| referrer_id</br>`string` |  |
| created_at</br>`string` |  |
| object</br>`string` | Available values: `voucher` |
...
| result | <p>Specifies the redeemable's end effect on the order. This object is unique to each type of redeemable.</p> Any of: [Coupon Code](#coupon-code), [Gift Card](#gift-card), [Loyalty Card](#loyalty-card), [Promotion Tier](#promotion-tier), [Promotion Stack](#promotion-stack) |
