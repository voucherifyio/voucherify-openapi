...
*Previous versions of the API are no longer supported, and we highly recommend upgrading to version 12.0.1, which is now designated as Long-Term Support (LTS).*
