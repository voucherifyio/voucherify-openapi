export const rawTakeList = {
  "/v1/loyalties/{campaignId}/points-expiration/export": {
    post: ["default", "ruby", "java", "php", "python"],
  },
  "/v1/customers/{customerId}/redeemables": {
    get: ["default", "ruby", "java", "php", "python"],
  },
  "/v1/vouchers/import": {
    post: ["default", "ruby", "java", "php", "python"],
  },
  ...
  "/v1/promotions/tiers": { get: ["default", "ruby", "java", "php", "python"] },
  "/v1/async-actions": { get: ["default", "ruby", "java", "php", "python"] },
  "/v1/async-actions/{asyncActionId}": {
    get: ["default", "ruby", "java", "php", "python"],
  },
  "/v1/segments": { post: ["default", "ruby", "java", "php", "python"] },
  "/v1/segments/{segmentId}": {
    delete: ["default", "ruby", "java", "php", "python"],
    get: ["default", "ruby", "java", "php", "python"],
  },
  ...
  "/v1/qualifications": { post: ["default", "ruby", "java", "php", "python"] },
  "/v1/validations": { post: ["default", "ruby", "java", "php", "python"] },
  "/v1/redemptions": {
    get: ["default", "ruby", "java", "php", "python"],
    post: ["default", "ruby", "java", "php", "python"],
  },
  ...
  "/v1/vouchers/{code}": {
    get: ["default", "ruby", "java", "php", "python"],
    post: ["default", "ruby", "java", "php", "python"],
    put: ["default", "ruby", "java", "php", "python"],
    delete: ["default", "ruby", "java", "php", "python"],
  },
  ...
  "/v1/orders/import": { post: ["default", "ruby", "java", "php", "python"] },
  "/v1/orders/export": { post: ["default", "ruby", "java", "php", "python"] },
  "/v1/products": {
    get: ["default", "ruby", "java", "php", "python"],
    post: ["default", "ruby", "java", "php", "python"],
  },
  ...
  "/v1/skus/{skuId}": { get: ["default", "ruby", "java", "php", "python"] },
  ...
  "/v1/skus/importCSV": { post: ["default", "ruby", "java", "php", "python"] },
  ...
  "/v1/events": { post: ["default", "ruby", "java", "php", "python"] },
  "/v1/exports": {
    post: ["default", "ruby", "java", "php", "python"],
    get: ["default", "ruby", "java", "php", "python"],
  },
  ...
  "/client/v1/events": { post: ["default", "ruby", "java", "php", "python"] },
};
