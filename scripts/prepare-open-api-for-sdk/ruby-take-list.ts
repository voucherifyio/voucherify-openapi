export const takeListRuby = [
  ...
  {
    endpoint: "/v1/loyalties/{campaignId}/members/{memberId}/points-expiration",
    methods: ["get"],
  },
  {
  ...
  {
    endpoint: "/v1/loyalties/{campaignId}/earning-rules/{earningRuleId}/enable",
    methods: ["post"],
  },
  {
    endpoint:
  ...
  {
    endpoint: "/v1/loyalties/{campaignId}/tiers/{loyaltyTierId}/earning-rules",
    methods: ["get"],
  },
  {
