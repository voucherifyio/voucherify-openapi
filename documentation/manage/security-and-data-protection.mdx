...
<AccordionGroup>
  <Accordion title="Data Processing Agreement (DPA)">
    Voucherify offers a Data Processing Agreement (DPA) for customers who collect data from individuals in the EU. The DPA provides contractual terms that meet GDPR requirements and reflect Voucherify's data privacy and security commitments.

    <Note>
      Log into Voucherify dashboard to [view an executable version of the Data Processing Agreement (DPA)](https://app.voucherify.io/#/app/account/legal/).
    </Note>
