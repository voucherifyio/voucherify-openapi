...
Account-level notifications relate to system limits and technical delivery. These settings apply to the whole account and are managed by the account owner.
