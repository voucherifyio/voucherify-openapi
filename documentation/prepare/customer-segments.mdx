...
<AccordionGroup>
  ...
  <Accordion title="Use segments in campaign validation rules">
    ...
    You can use segments in [validation rules](https://support.voucherify.io/article/529-validation-rules-campaign-limits) to decide who can use a campaign. The system checks if a customer belongs to a segment at the moment of validation. This is useful when eligibility depends on customer data, such as account status or past activity.
