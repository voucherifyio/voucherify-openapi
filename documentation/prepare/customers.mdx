...
<Steps>
  <Step title="Prepare the file">
    Download the <a href="/examples/import-customers-template.csv" download>CSV import template</a> and populate it with customer data using supported field names.
  </Step>
