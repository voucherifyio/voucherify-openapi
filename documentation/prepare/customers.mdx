...
<Steps>
  <Step title="Prepare the file">
    Download the [CSV Import Template](https://raw.githubusercontent.com/voucherifyio/voucherify-openapi/refs/heads/master/documentation/examples/import-customers-template.csv) and populate it with customer data using supported field names.
  </Step>
