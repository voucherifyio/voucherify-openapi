...
<Steps>
  <Step title="Prepare the file">
    Download the [CSV Import Template](https://cdn.jsdelivr.net/gh/voucherifyio/voucherify-openapi@master/documentation/examples/import-prdoucts-template.csv) and fill it with your product data. 
