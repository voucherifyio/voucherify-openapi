...
<AccordionGroup>
  ...
  <Accordion title="Use products in validation rules">
    Product data can be used in [validation rules](/personalize/validation-rules-reference) to control when a promotion applies. For example, you can limit a campaign to selected products or require specific items in the cart.
  </Accordion>
