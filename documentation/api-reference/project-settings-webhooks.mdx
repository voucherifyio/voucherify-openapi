...
- `data` (`object`): Payload depends on the event that triggered the webhook sendout. Project settings cover the following events:
  - [business_validation_rule.assignment.created](/api-reference/events-bus_val_rule-assignment-created)
  - [business_validation_rule.assignment.deleted](/api-reference/events-bus_val_rule-assignment-deleted)
  - [business_validation_rule.created](/api-reference/events-bus_val_rule-created)
  - [business_validation_rule.deleted](/api-reference/events-bus_val_rule-deleted)
  - [business_validation_rule.updated](/api-reference/events-bus_val_rule-updated)
  - [campaign.created](/api-reference/events-campaign-created)
  - [campaign.deleted](/api-reference/events-campaign-deleted)
  - [campaign.disabled](/api-reference/events-campaign-disabled)
  - [campaign.enabled](/api-reference/events-campaign-enabled)
  - [campaign.updated](/api-reference/events-campaign-updated)
  ...
  - [campaign.loyalty_tier.created](/api-reference/events-campaign-loyalty_tier-created)
  - [campaign.loyalty_tier.deleted](/api-reference/events-campaign-loyalty_tier-deleted)
  - [campaign.loyalty_tier.updated](/api-reference/events-campaign-loyalty_tier-updated)
  - [campaign.promotion_tier.created](/api-reference/events-campaign-promotion_tier-created)
  - [campaign.promotion_tier.deleted](/api-reference/events-campaign-promotion_tier-deleted)
  - [campaign.promotion_tier.disabled](/api-reference/events-campaign-promotion_tier-disabled)
  - [campaign.promotion_tier.enabled](/api-reference/events-campaign-promotion_tier-enabled)
  - [campaign.promotion_tier.updated](/api-reference/events-campaign-promotion_tier-updated)
  ...
  - [campaign.vouchers.generation.completed](/api-reference/events-campaign-vouchers-generation-completed)
  - campaign.vouchers.generation.failed
  - campaign.vouchers.generation.started
  - campaign.vouchers.added
  - [customer.created](/api-reference/events-customer-created)
  - [customer.deleted](/api-reference/events-customer-deleted)
  - customer.confirmed
  - [customer.rewarded](/api-reference/events-customer-rewarded)
  - [customer.rewarded.loyalty_points](/api-reference/events-customer-rewarded-loyalty_points)
  - [publication.succeeded](/api-reference/events-publication-succeeded)
  - [redemption.failed](/api-reference/events-redemption-failed)
  - [redemption.rollback.failed](/api-reference/events-redemption-rollback-failed)
  - [redemption.rollback.succeeded](/api-reference/events-redemption-rollback-succeeded)
  - [redemption.succeeded](/api-reference/events-redemption-succeeded)
  - [voucher.created](/api-reference/events-voucher-created)
  - [voucher.deleted](/api-reference/events-voucher-deleted)
  - [voucher.disabled](/api-reference/events-voucher-disabled)
  - [voucher.enabled](/api-reference/events-voucher-enabled)
  - [voucher.gift.balance_added](/api-reference/events-voucher-gift-balance_added)
  - [voucher.gift.transaction.created](/api-reference/events-voucher-gift-transaction-created)
  - [voucher.loyalty_card.pending_points.activated](/api-reference/events-voucher-loyalty_card-pending_points-activated)
  - [voucher.loyalty_card.pending_points.added](/api-reference/events-voucher-loyalty_card-pending_points-added)
  - [voucher.loyalty_card.pending_points.canceled](/api-reference/events-voucher-loyalty_card-pending_points-canceled)
  - [voucher.loyalty_card.pending_points.updated](/api-reference/events-voucher-loyalty_card-pending_points-updated)
  - [voucher.loyalty_card.points_added](/api-reference/events-voucher-loyalty_card-points_added)
  - [voucher.loyalty_card.points_expired](/api-reference/events-voucher-loyalty_card-points_expired)
  - [voucher.loyalty_card.transaction.created](/api-reference/events-voucher-loyalty_card-transaction-created)
  - [voucher.published](/api-reference/events-voucher-published)
  - [voucher.updated](/api-reference/events-voucher-updated)
