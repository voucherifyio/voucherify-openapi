...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>
          Custom error returned when validation or redemption fails the defined rules. Resolved to
          <code>{ message }</code>
          at request time using
          <code>options.language</code>.
        </p>
        <a href="#validation-rule-error">Validation Rule Error</a>
      </td>
    </tr>
    <tr>
      <td>
        ...
        <table>
          ...
          <tbody>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <br />
                        campaign.redemptions.customers_count.weekly
                        <br />
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <br />
                        redemption.count.per_customer.weekly
                        <br />
            ...
            <tr>
              ...
              <td>
                <p>
                  Custom error returned when validation or redemption fails the defined rule. Resolved to
                  <code>{ message }</code>
                  at request time using
                  <code>options.language</code>.
                </p>
            ...
            <tr>
              ...
              <td>
                <p>
                  ...
                  Custom error returned when validation or redemption fails the defined bundle rule. Resolved to
                  <code>{ message }</code>
                  at request time using
                  <code>options.language</code>.
                </p>
...
<h2 id="validation-rule-error">Validation Rule Error</h2>
<table>
  <thead>
    <tr>
      <th>Attributes</th>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <p>
          Legacy single-language error message. Used when
          <code>mode</code>
          is omitted. In
          <code>MESSAGES</code>
          mode, used when neither the requested language nor the default language has a translation.
        </p>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <p>
          Selects how the custom error is defined.
          <code>MESSAGES</code>
          stores per-language text in
          <code>messages</code>.
          <code>LIBRARY</code>
          references an Error Message Library entry in
          <code>library</code>.
          Omit
          <code>mode</code>
          to use the legacy
    ...
    <tr>
      ...
      <td>
        <p>
          Per-language custom messages keyed by language code (
          <code>en</code>,
          <code>pl</code>,
          <code>en-US</code>
          ). Required when
    ...
    <tr>
      ...
      <td>
        See:
        <a href="#validation-rule-error-library">Validation Rule Error Library</a>
      </td>
    </tr>
  </tbody>
</table>
...
<h2 id="validation-rule-error-library">Validation Rule Error Library</h2>
<table>
  <thead>
    <tr>
      <th>Attributes</th>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <p>
          Identifies the library message. Use a validation-rule name such as
          <code>order.amount</code>,
          or a custom attribute key such as
          <code>order.metadata.location</code>.
        </p>
        <p>
          <strong>Example:</strong>
          order.amount
