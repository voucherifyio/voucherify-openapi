...
The `source.object` value identifies the webhook type:

* `webhook` for Project settings webhooks
* `distribution` for Distribution webhooks
* `workflow` for Workflows webhook callouts
