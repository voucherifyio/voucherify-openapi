---
title: "Tier created"
description: "Event data sent for a Loyalty v2 vl.tier_structure.tier.created activity handled by Workflows"
openapi: "/openapi-events/events-loyalty-activity.json webhook vl.tier_structure.tier.created"
keywords: ["loyalty v2", "workflow", "webhook", "tier created", "loyalty activity"]
---
