...
<ol>
  ...
  <li>
    <a href="#export-product">Export Product</a>
  </li>
  <li>
    <a href="#export-sku">Export SKU</a>
  </li>
</ol>
...
<h2 id="export-product">Export Product</h2>
<p>All of:</p>
<ol>
  <li>
    <a href="#export-base">Export Base</a>
...
<h2 id="export-sku">Export SKU</h2>
<p>All of:</p>
<ol>
  <li>
    <a href="#export-base">Export Base</a>
  ...
  <li>
    <a href="#export-skus">Export SKUs</a>
  </li>
</ol>
...
<h2 id="export-products">Export Products</h2>
<table>
  <thead>
    <tr>
      <th>Attributes</th>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <a href="#export-product-order">Export Product Order</a>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <p>
                  Array of strings containing the data in the export. These fields define the headers in the CSV file. The
                  <code>metadata</code>
                  field expands into one CSV column per metadata property. You can also pass specific properties as
                  <code>metadata.&#x3C;property_name></code>.
                </p>
                Array of
                <a href="#export-product-fields">Export Product Fields</a>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <p>Filter conditions.</p>
                <a href="#export-product-filters">Export Product Filters</a>
              </td>
            </tr>
          </tbody>
        </table>
...
<h2 id="export-skus">Export SKUs</h2>
<table>
  <thead>
    <tr>
      <th>Attributes</th>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <a href="#export-sku-order">Export SKU Order</a>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                ...
                Array of
                <a href="#export-sku-fields">Export SKU Fields</a>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <p>Filter conditions.</p>
                <a href="#export-sku-filters">Export SKU Filters</a>
              </td>
            </tr>
          </tbody>
        </table>
...
<h2 id="export-product-order">Export Product Order</h2>
<p>
  Available values:
  <code>-created_at</code>,
  <code>created_at</code>,
...
<h2 id="export-product-fields">Export Product Fields</h2>
<p>
  Available values:
  <code>id</code>,
  <code>name</code>,
...
<h2 id="export-product-filters">Export Product Filters</h2>
<table>
  <thead>
    <tr>
      <th>Attributes</th>
...
<h2 id="export-sku-order">Export SKU Order</h2>
<p>
  Available values:
  <code>-created_at</code>,
  <code>created_at</code>,
...
<h2 id="export-sku-fields">Export SKU Fields</h2>
<p>
  Available values:
  <code>id</code>,
  <code>sku</code>,
...
<h2 id="export-sku-filters">Export SKU Filters</h2>
<table>
  <thead>
    <tr>
      <th>Attributes</th>
