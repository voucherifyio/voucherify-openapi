---
title: "Errors"
description: "Learn about the errors returned to responses and how you can customize them to improve your customer experience"
keywords: ['HTTP', 'error', 'customize', 'message']
---
...
| 403              | Forbidden                 | The request was sent to a region your project is not bound to (`wrong_api_endpoint`). The error `details` field returns the base URL you should use, for example `https://us1.api.voucherify.io`. See [API overview](/guides/api-overview#choose-the-right-api-endpoint). |
...
| `wrong_api_endpoint`                  | the request was sent to a region the project is not bound to; use the base URL returned in the error `details` field                                                                                                                 |
