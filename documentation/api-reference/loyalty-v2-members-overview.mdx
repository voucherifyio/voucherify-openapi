...
- [List](/api-reference/programs/list-card-pending-point-buckets), and optionally manually [activate](/api-reference/programs/activate-pending-point-bucket) or [cancel](/api-reference/programs/cancel-pending-point-bucket), pending points buckets before their scheduled activation date.
- [List](/api-reference/programs/list-card-expiring-points-buckets), and optionally manually [expire](/api-reference/programs/expire-point-bucket), expiring points buckets before their scheduled expiration date.
