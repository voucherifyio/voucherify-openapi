    ...
    <tr>
      ...
      <td>
        <p>
          ...
          Read more in
          <a href="/orchestrate/stacking-rules">the Stacking rules article</a>.
        </p>
        Array any of:
        <ol>
          <li>
    ...
    <tr>
      ...
      <td>
        <p>
          ...
          <a href="/orchestrate/stacking-rules">Stacking Rule Documentation</a>.
        </p>
            ...
            <tr>
              ...
              <td>
                ...
                <ol>
                  ...
                  <li>
                    <a href="#validations-redeemable-skipped-result-no-effect">Validations Redeemable Skipped Result No Effect</a>
                  </li>
                </ol>
              </td>
            </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>Includes the resolved custom validation-rule error message when one is configured.</p>
        <table>
          <thead>
            <tr>
              <th>Attributes</th>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <p>
                  Resolved custom validation-rule error message for
                  <code>options.language</code>,
                  falling back to the Error Message Library default language. Present only when a custom message can be resolved.
                </p>
              </td>
            </tr>
          </tbody>
...
<h2 id="validations-redeemable-skipped-result-no-effect">Validations Redeemable Skipped Result No Effect</h2>
<table>
  <thead>
    <tr>
      <th>Attributes</th>
