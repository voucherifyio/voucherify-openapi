...
This setting allows vouchers to be valid for a fixed period after they are <Tooltip headline="Publication" tip="Publishing means assigning a code to a specific customer profile. This can be done through the Dashboard or API." cta="Read the Publication article" href="/orchestrate/code-publication#code-publication">published</Tooltip> to a customer
