...
Use the **Formula builder** to define a dynamic value for discounts, product units, replacement units, or loyalty points.

The formula builder helps you create formulas by typing directly, selecting variables, metadata, functions, and operators, using templates, or working in the diagram view. Templates provide starting points for common logic, such as calculations based on order amount, customer metadata, or order currency.
...
Open **Templates** and select a template.
...
Select **Show diagram** to open the formula in a diagram view.
...
In the diagram view, you can also:
