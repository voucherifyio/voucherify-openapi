...
- **Redemptions per customer in a campaign per day**: Define the weekly limit of redemptions that a particular customer can make using codes from a particular campaign. The first day of the week is Monday, for example between Monday 00:00 5 January 2026 and until the end of Sunday 23:59 11 January 2026.
