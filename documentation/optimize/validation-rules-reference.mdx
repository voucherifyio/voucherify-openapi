...
These rules define validation based on order value and pricing.
...
- **Initial amount**: The original cart value before any discounts or other campaign effects are applied. This value remains **constant** throughout stacking.

- **Total amount before discounts**: The cart value at the moment a given incentive is validated, before applying the discount from the current incentive. This value may change depending on previously applied incentives.
...
| **Total amount before discounts** | Cart value at validation time          | ✅ Yes                  | Depend on current cart value |
...
- **Total amount before discounts**: Requires the cart value (at validation time, before applying the current incentive) to meet a specified threshold.
...
- **Initial amount**: Requires the original cart value (before any discounts or stacking adjustments) to meet a specified threshold.
...
- **Total number of redemptions per week**: Define the weekly limit of redemptions allowed in the entire campaign for all customers (the sum of all redemptions made with unique codes from the campaign). The first day of the week (Monday, Saturday, or Sunday) is defined in **Project settings** > Locale. For Monday, a week lasts between Monday 00:00 and until the end of Sunday 23:59.is Monday, for example between Monday 00:00 6 January 2026 and until the end of Sunday 23:59 11 January 2026.
...
- **Redemptions per incentive per day**: Define the daily limit of redemptions for a given incentive. The day is a calendar day, for example 1 January 2025.
- **Redemptions per incentive per week**: Define the weekly limit of redemptions for a given incentive. The first day of the week (Monday, Saturday, or Sunday) is defined in **Project settings** > Locale. For Monday, a week lasts between Monday 00:00 and until the end of Sunday 23:59.is Monday, for example between Monday 00:00 5 January 2026 and until the end of Sunday 23:59 11 January 2026.
- **Redemptions per incentive per month**: Define the monthly limit of redemptions for a given incentive. The month is a calendar month, for example January.
- **Redemptions per customer per incentive**: Define the total number of redemptions that a particular customer can make using a given incentive.
- **Redemptions per customer per incentive per day**: Define the daily limit of redemptions that a particular customer can make using a given incentive. The day is a calendar day, for example 1 January 2025.
...
- **Redemptions per customer per incentive per month**: Define the monthly (calendar month) limit of redemptions that a particular customer can make using a given incentive. The month is a calendar month, for example January.
...
- **Redemptions per customer in a campaign per week**: Define the weekly limit of redemptions that a particular customer can make using codes from a particular campaign. The first day of the week (Monday, Saturday, or Sunday) is defined in **Project settings** > Locale. For Monday, a week lasts between Monday 00:00 and until the end of Sunday 23:59.is Monday, for example between Monday 00:00 5 January 2026 and until the end of Sunday 23:59 11 January 2026.
