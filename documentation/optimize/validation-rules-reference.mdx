...
- **Total orders value**: Define the value of all orders made within the campaign. Once the limit is reached, customers cannot redeem incentives (codes or promotion tiers).
- **Total discounted amount**: Define the overall value of the discount that the customers can get by redeeming incentives (codes or promotion tiers) from a particular campaign.
...
- **Redemptions per customer in a campaign per day**: Define the daily limit of redemptions that a particular customer can make using incentives (codes or promotion tiers) from a particular campaign. The day is a calendar day, for example 1 January 2025.
- **Redemptions per customer in a campaign per week**: Define the weekly limit of redemptions that a particular customer can make using incentives (codes or promotion tiers) from a particular campaign. The first day of the week (Monday, Saturday, or Sunday) is defined in **Project settings** > Locale. For Monday, a week lasts between Monday 00:00 and the end of Sunday 23:59, for example between Monday 00:00 5 January 2026 and the end of Sunday 23:59 11 January 2026.
- **Redemptions per customer in a campaign per month**: Define the monthly (calendar month) limit of redemptions that a particular customer can make using incentives (codes or promotion tiers) from a particular campaign. The month is a calendar month, for example January.
