...
*   Create Customer (creates a new customer profile in the Voucherify repository. If a customer with the given source id already exists, they will be updated).
...
If the test is successful, you see the screen saying "Your Zap Is Ready!".
...
For example, you can integrate Zapier with Slack or Gmail to receive Voucherify notifications straight to your Slack channels or email inbox.