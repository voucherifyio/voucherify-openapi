...
*   **Show your customers unique coupon codes in a popup** using the [Create Publication](https://docs.voucherify.io/reference/create-publication) API call
*   **Show the list of vouchers for a single customer** using the [List Vouchers](https://docs.voucherify.io/reference/list-vouchers) API call
*   And many more!

Please refer to our [API reference](https://docs.voucherify.io/reference) to get the most out of Voucherify.
...
One of the arguments is going to be the payload of the POST request. You need to align the payload to the API requests noted in Voucherify’s API reference. In our case, we are going to use the [Create Order API call](https://docs.voucherify.io/reference/create-order).
...
The API calls sent to Voucherify must contain your API keys. To get the keys, you can find them in your [project settings](https://docs.voucherify.io/docs/authentication).
