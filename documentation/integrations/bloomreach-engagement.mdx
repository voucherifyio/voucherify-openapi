...
<Note>
The integration with Bloomreach CDP uses [webhook limits](https://docs.voucherify.io/docs/limits#webhooks) for sending data from Bloomreach CDP to Voucherify.
</Note>
<Warning>
...
The payload you send to Voucherify is described in detail in the [Publication API endpoint](https://docs.voucherify.io/reference/create-publication). In the payload, you need to provide the customer’s hard id and the name of the campaign.
...
*   **Sync Voucherify Customer's ID** – If enabled, the Voucherify Customer’s ID will be stored in Bloomreach Engagement as either a Hard or Soft ID.[](https://s3.amazonaws.com/helpscout.net/docs/assets/5902f1c12c7d3a057f88a36d/images/653782301ec9493542048984/file-IDbe2bIy4p.png)
