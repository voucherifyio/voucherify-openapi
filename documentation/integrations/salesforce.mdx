...
4. As an example, we’ll configure the plugin in a way that it syncs Salesforce Contact entity into Voucherify Customer object:  
     ...
     * Choose which SF fields from the Contact entity will serve as a unique identifier in Customer object (read more about source\_id in the [API reference](https://docs.voucherify.io/reference#create-customer)). Usually, you might want to choose Id or Email fields.
