...
<Steps>
   ...
   <Tip>
      ...
      You can fetch any field from from Voucherify's response.
   ...
   Rate limits protect your margins during testing and live traffic. When running A/B tests or scaling campaigns, uncontrolled sending can exhaust code pools or exceed budget caps.
...
In Voucherify, go to **Audit logs** to check if Braze has successfully called the API.
