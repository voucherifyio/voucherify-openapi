...
*   The **synchronization** of the customer, order, and product data can be used to build [earning rules in loyalty programs](/build/loyalty-campaign-overview), [dynamic segmentation](/prepare/customer-segments), or set up [validation rules](/personalize/create-validation-rules). 
