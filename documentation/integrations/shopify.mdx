...
*   The **synchronization** of the customer, order, and product data can be used to build [earning rules in loyalty programs](/build/loyalty-campaign-overview), [dynamic segmentation](/prepare/customer-segments), or set up [validation rules](https://support.voucherify.io/article/148-how-to-build-a-rule). 
