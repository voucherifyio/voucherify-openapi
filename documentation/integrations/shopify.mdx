...
When it comes to the loyalty program, Shopify can be used as a **channel for reward redemption**, which means that when the customer purchases the reward (e.g., discount code) with his/her loyalty points, the code will be automatically sent to the customer and to Shopify so that he or she can redeem it at the checkout. To learn more about notifications, [follow this tutorial](https://support.voucherify.io/article/177-how-to-create-loyalty-program-step-by-step#notifications).