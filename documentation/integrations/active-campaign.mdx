---
title: "Active Camapign"
keywords: ['integration', 'active', 'campaign']
---
...
**The integration with ActiveCampaign consumes** [webhook limits](https://docs.voucherify.io/docs/limits#webhooks) **for sending messages, but actions that are sent from ActiveCampaign to Voucherify consume** [API limits](https://docs.voucherify.io/docs/limits#api-limits)**.**
...
Firstly, open your Integrations tab in the Home section and expand ActiveCampaign integration.

Copy your API key and URL address (the endpoint) from ActiveCampaign settings. 

Please paste the copied data into Voucherify. **The API endpoint should start with "https://."**
...
Please visit [this tutorial](https://www.activecampaign.com/learn/guides/what-are-custom-fields) to learn more about fields in ActiveCampaign.
