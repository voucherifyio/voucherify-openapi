...
The API requests return the complete definition of the coupon code, so if you have added any kind of information to the [metadata](https://support.voucherify.io/article/99-schema-validation-metadata), it can also be shown in the same way: `[[voucher.code.voucher.metadata.marketing_text]]`
