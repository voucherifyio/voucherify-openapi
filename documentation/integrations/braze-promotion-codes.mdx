...
<Steps>
  ...
  <Step title="Create a promotion code list in Braze">
    ...
    <Note>
      ...
      You can set attributes like **List Expiration** and **Threshold Alerts**. Note that Voucherify manages its own expiration logic for codes regardless of these list settings.
