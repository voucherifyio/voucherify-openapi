...
<Steps>
  <Step title="Export unique codes from Voucherify Campaign">
    ...
    In Voucherify, go to **Campaigns** and select the campaign whose codes you want to export:
  ...
  <Step title="Upload the CSV file with promotion codes">
    ...
    Larger files take several minutes to import. You can leave the page while the import is in progress.
