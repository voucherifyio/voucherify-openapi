...
<Note>
To generate unique personalized vouchers, a Voucherify [Discount Code Campaign](https://support.voucherify.io/article/46-bulk-unique-codes-campaign) needs to be configured. Then, the codes can be generated via [Voucherify’s Create Publication API endpoint](/api-reference/publications/create-publication).
</Note>
