...
Infobip, a global communication platform, allows businesses to engage customers through SMS, WhatsApp, and email, while Voucherify enables personalized [promotions](https://support.voucherify.io/article/519-create-cart-level-promotions), [vouchers](https://support.voucherify.io/article/514-coupons), and [loyalty programs](https://support.voucherify.io/article/177-how-to-create-loyalty-program-step-by-step). By combining the strengths of both platforms, you can streamline marketing campaigns that engage your customers across channels with personalized offers. Some example use cases in marketing campaign engagement scenarios are:

*   **Automated Birthday Campaigns** **via various Messaging Channels**. Automatically send personalized [birthday offers](https://support.voucherify.io/article/517-birthday-campaign) to customers via their preferred messaging channel (e.g., WhatsApp, SMS, Viber) to enhance engagement and encourage voucher redemption.
...
<Note>
To generate unique personalized vouchers, a Voucherify [Discount Code Campaign](https://support.voucherify.io/article/46-bulk-unique-codes-campaign) needs to be configured. Then, the codes can be generated via [Voucherify’s Create Publication API endpoint](https://docs.voucherify.io/reference/create-publication).
</Note>
