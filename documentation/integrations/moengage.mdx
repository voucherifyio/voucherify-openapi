...
You will need the campaign ID needed later. You can obtain the ID by calling [the get campaign endpoint](https://docs.voucherify.io/reference/get-campaign) or copy it from the web browser address bar when you open the campaign dashboard.
