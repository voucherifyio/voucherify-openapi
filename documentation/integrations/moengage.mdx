...
You will need the campaign ID needed later. You can obtain the ID by calling [the get campaign endpoint](https://docs.voucherify.io/api-reference/campaigns/get-campaign) or copy it from the web browser address bar when you open the campaign dashboard.
...
3.  To extract only the published voucher’s code from the response, use this expression:
