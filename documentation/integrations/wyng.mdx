...
Begin by [exporting](about://support.voucherify.io/article/543-data-export#vouchers) the desired set of codes from Voucherify. Ensure that these codes are not published or distributed directly through Voucherify.
...
For security reasons, it is recommended to use the [client-side API](https://docs.voucherify.io/guides/api-overview#client-side-api-browser-and-mobile) for a custom JS integration. Ensure proper client-side settings by:
