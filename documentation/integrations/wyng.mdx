...
For security reasons, it is recommended to use the [client-side API](https://docs.voucherify.io/docs/client-side-api) for a custom JS integration. Ensure proper client-side settings by:
