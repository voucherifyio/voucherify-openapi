...
Combine Braze-to-Voucherify data with the following features.
...
<AccordionGroup>
    ...
    Use Braze Canvas webhook messages to call the [Track custom events](/api-reference/events/track-custom-event) endpoint in Voucherify. Example use cases:
