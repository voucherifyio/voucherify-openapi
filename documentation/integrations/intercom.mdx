...
**The integration with Intercom consumes [webhook limits](https://docs.voucherify.io/guides/limits#webhooks) for sending messages, but actions that are sent from Intercom to Voucherify consume [API limits](https://docs.voucherify.io/guides/limits#api-limits).**
...
When both accounts are connected, you need to add your customers from Intercom to Voucherify. Use [the CSV file and import tool](https://support.voucherify.io/article/67-how-to-import-my-customers) or add customers by using [Voucherify API](https://docs.voucherify.io/api-reference/customers/create-customer). 
