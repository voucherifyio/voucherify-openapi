...
When both accounts are connected, you need to add your customers from Intercom to Voucherify. Use [the CSV file and import tool](https://support.voucherify.io/article/67-how-to-import-my-customers) or add customers by using [Voucherify API](/api-reference/customers/create-customer). 
