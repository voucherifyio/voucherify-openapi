...
<AccordionGroup>
    ...
    Braze campaigns can include a [Connected Content script](/integrations/braze-connected-content) to use Voucherify API endpoints to perform different actions, like publishing a code. Braze delivers the message while Voucherify handles incentive eligibility and protects your budget with different guardrails like [validation rules](/optimize/validation-rules-reference).
