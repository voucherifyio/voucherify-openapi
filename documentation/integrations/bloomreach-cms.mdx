...
*   [Discount coupons](https://support.voucherify.io/article/514-coupons),
*   [Gift vouchers](https://support.voucherify.io/article/47-prepaid-gift-cards-campaign),
*   [Referral code](https://support.voucherify.io/category/388-referral-campaigns)
*   [Promotion tiers](https://docs.voucherify.io/api-reference/promotions/promotion-tier-object),
*   [Earning rules](https://support.voucherify.io/article/491-getting-started-with-loyalty-programs#earning-rules) (within a [loyalty program](https://support.voucherify.io/article/491-getting-started-with-loyalty-programs)).

**The integration with Bloomreach CMS uses [API limits](https://docs.voucherify.io/guides/limits#api-limits) for downloading campaigns**.
...
2.  Fill in the **Application URL** field to proper address, e.g.:
