...
This Connected Content script calls Voucherify API to publish a unique coupon code and send it in a Braze message. Each Braze user receives only one unique code.
...
To display the published referral code in your message, use the following snippet.
