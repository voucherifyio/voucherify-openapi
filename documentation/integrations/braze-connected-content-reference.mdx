...
This Connected Content script retrieves all unredeemed discount coupons assigned to a Braze user. It loops through the customer's vouchers and displays only the ones that haven't been used yet.
