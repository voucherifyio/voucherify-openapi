...
keywords: ['integration', 'CEP', 'customer engagement', 'Braze', 'Klaviyo', 'MoEngage', 'Bloomreach', 'Iterable', 'CleverTap', 'Customer.io']
---
...
<Card title="Customer.io" icon="envelope" href="/integrations/customer-io">
  Webhook-driven code distribution and custom profile attributes for cross-channel journeys.
</Card>
</CardGroup>
