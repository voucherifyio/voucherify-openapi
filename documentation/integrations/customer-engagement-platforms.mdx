...
| **API calls from CEP** | Your CEP calls Voucherify APIs (via Connected Content, Content API, or webhooks) to fetch or publish codes. | Dynamically insert a unique code into an email at send time. |
...
<CardGroup cols={2}>
<Card title="Braze" icon="message" href="/integrations/braze">
...
<Card title="MoEngage" icon="mobile" href="/integrations/moengage">
  Content API integration for real-time code publication in campaigns.
</Card>

<Card title="Bloomreach Engagement" icon="chart-line" href="/integrations/bloomreach-engagement">
  Bidirectional sync: send events to Bloomreach and receive customer updates.
</Card>

<Card title="Iterable" icon="repeat" href="/integrations/iterable">
  Webhook-based integration for code distribution and event tracking.
</Card>

<Card title="CleverTap" icon="bullseye" href="/integrations/clevertap">
...
1. **Connect your CEP** – Go to **Integrations** in your Voucherify Dashboard and configure API keys for your platform.
