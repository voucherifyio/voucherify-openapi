...
**The integration with BigCommerce uses [webhook limits](https://docs.voucherify.io/docs/limits#webhooks) for syncing customers and products in BigCommerce, but sending code validation and redemption from BigCommerce to Voucherify consumes [API limits](https://docs.voucherify.io/docs/limits#api-limits)**.
