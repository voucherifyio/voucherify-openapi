...
**The integration with BigCommerce uses [webhook limits](https://docs.voucherify.io/guides/limits#webhooks) for syncing customers and products in BigCommerce, but sending code validation and redemption from BigCommerce to Voucherify consumes [API limits](https://docs.voucherify.io/guides/limits#api-limits)**.
...
*   The latest v3 plugin version was released on 23/08/2021 ([Release note v20210806](https://support.voucherify.io/article/23-whats-new-in-voucherify)). It adds support for stacking gift cards and fixed price discounts. If you connected your store before that day, you need to re-install your integration to access new features. [Read how to upgrade your integration](#upgrade).
...
If you'd like to upgrade to the latest version of the Voucherify &lt;&gt; BigCommerce plugin, you need to reinstall your integration with BigCommerce. It comes down to [disconnecting](#disconnect) Voucherify and BigCommerce accounts and [connecting](#install) them again.
...
*   [Customers](https://support.voucherify.io/article/67-how-to-import-my-customers)
*   [Products](https://support.voucherify.io/article/515-products)
*   [Orders](https://support.voucherify.io/article/263-how-can-i-track-customer-orders)
...
Visit our guide on metadata to learn more about how metadata works in Voucherify. [Read more.](https://support.voucherify.io/article/99-schema-validation-metadata)
...
1.  Let's open the Projects Settings and then Metadata Schema. 
2.  First, we need to create a new nested property with fields:  
...
4.  Then, assign the created nested property to the new object:  **bigcommerce\_customer\_group**.
    ...
    Please note that to sync data properly, you need to use the same name for this object (bigcommerce\_customer\_group) in your Metadata Schema.
...
Now, you can use your customer groups to create validation rules (limits and rules of your promotions). [Go here to learn more.](#validate)
...
<Note>
If you're not familiar with our validation rules builder, please [follow this guide](https://support.voucherify.io/article/529-validation-rules-campaign-limits) first.
</Note>
...
You can read more about product collections in [this guide](https://support.voucherify.io/article/515-products).
...
When it comes to the **Order structure** validation rules, you can use product categories to define the required cart items, subtotals, and quantity. Go [here](https://support.voucherify.io/article/529-validation-rules-campaign-limits#product-metadata) to read more. 
...
<Note>
If you need help with creating gift cards, follow this detailed tutorial [here](https://support.voucherify.io/article/47-prepaid-gift-cards-campaign).
</Note>
### Stacking gift cards
...
You can create a [unique codes campaign](https://support.voucherify.io/article/46-bulk-unique-codes-campaign) or [generic codes](https://support.voucherify.io/article/49-fixed-code-campaign) with percentage, amount, unit, free shipping, and fixed price discounts.

<Note>
You can read the description of each discount type in [this guide](https://support.voucherify.io/article/512-complete-user-guide-on-discounts).
</Note>
