...
You can create a [unique codes campaign](/build/create-discount-coupons) or [generic codes](https://support.voucherify.io/article/49-fixed-code-campaign) with percentage, amount, unit, free shipping, and fixed price discounts.
