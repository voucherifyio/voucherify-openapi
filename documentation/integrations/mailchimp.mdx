...
2.  Create a [coupon campaign](https://support.voucherify.io/article/46-bulk-unique-codes-campaign).
...
4.  Set optional [time limitations](https://support.voucherify.io/article/132-time-limits-for-vouchers).
