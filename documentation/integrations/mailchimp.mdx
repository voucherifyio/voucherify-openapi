...
When you confirm the configuration, the distribution starts. When a customer enters the synced Mailchimp list, Voucherify automatically assigns a code from the chosen campaign to the merge tag in their profile.
