...
**The integration with Mailchimp consumes** [API limits](https://docs.voucherify.io/docs/limits#api-limits) **for actions that are sent from Mailchimp to Voucherify.**
