...
description: "Learn how to use distribution with Braze Custom Attributes"
...
Before you use Braze custom attributes in Voucherify distributions, you need to add your Braze users to the Voucherify dashboard. You can use Braze connected content to synchronize users or import your customers through CSV or API. [Go here](/prepare/customers) to read more about customer import.
