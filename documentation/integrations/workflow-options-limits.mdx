...
| **Publish** | Creates a new published version from the saved canvas. An active workflow starts using it right away. | When the canvas is complete and fully saved. |
