---
title: "Braze"
description: "send data from Voucherify API to Braze"
...
Campaigns may use a Connected Content script to publish a unique coupon code and send it in a Braze message. More information about it in this [article](https://support.voucherify.io/article/573-braze-connected-content).
