...
**The integration with Braze consumes** [API limits](https://docs.voucherify.io/docs/limits#api-limits) **for Connected Content and** [webhook limits](https://docs.voucherify.io/docs/limits#webhooks) **for sending codes to Braze with custom attributes, as well as synchronizing the audience in Braze.**
...
7.  In the Request Body, form the proper payload for the [track event](https://docs.voucherify.io/reference/track-custom-event) endpoint.
