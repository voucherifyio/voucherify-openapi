...
**The integration with CommerceTools uses** [API limits](https://docs.voucherify.io/docs/limits#api-limits) **for sending code validation and redemption from Voucherify to CommerceTools and vice versa.**
...
- [Stackable discounts](https://docs.voucherify.io/docs/manage-stackable-discounts) – allow customers to use up to 30 incentives at the same time.
