...
**The integration with CommerceTools uses** [API limits](https://docs.voucherify.io/guides/limits#api-limits) **for sending code validation and redemption from Voucherify to CommerceTools and vice versa.**
...
- [Validation sessions](https://docs.voucherify.io/guides/locking-validation-session) – temporarily lock the voucher's usage until redemption is successful, which is helpful for coupons with limited use.
- [Stackable validation](https://docs.voucherify.io/api-reference/validations/validate-stackable-discounts) and [stackable redemption](https://docs.voucherify.io/api-reference/redemptions/redeem-stackable-discounts) – allow customers to use up to 30 incentives at the same time.
