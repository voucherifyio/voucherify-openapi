...
description: "Learn how to prepare data, build campaigns, and personalize incentives in the Voucherify dashboard"
...
<Card title="Personalize" icon="sliders" href="/personalize/personalize-overview">
...
3. **Personalize**: Add validation rules to control who can redeem, set time windows, and create rewards.
...
- **Fine-tuning?** Use [Personalize](/personalize/personalize-overview) to add targeting rules.