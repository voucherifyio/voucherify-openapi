...
description: "Learn how to prepare data, build campaigns, optimize incentives, orchestrate operations, analyze performance, and manage your account in the Voucherify dashboard"
...
<Card title="Orchestrate" icon="sitemap" href="/orchestrate/orchestrate-overview">
  Publish codes, maintain campaigns, control stacking rules, and manage areas and stores.
</Card>

<Card title="Analyze" icon="chart-line" href="/analyze/analyze-overview">
  Track campaign and voucher activity, review redemption analytics, and audit project changes.
</Card>

<Card title="Manage" icon="user-gear" href="/manage/manage-voucherify-overview">
