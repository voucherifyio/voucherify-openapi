...
<Card title="Personalize" icon="sliders" href="/optimize/personalize-overview">
...
- **Fine-tuning?** Use [Personalize](/optimize/personalize-overview) to add targeting rules.