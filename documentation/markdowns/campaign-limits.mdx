...
![Validation rule builder](/images/docs/df4c130-guides_integration_blueprint_campaign_limits-01.png "The rule builder for campaign validation")
...
![](/images/docs/5668eba-guides_integration_blueprint_campaign_limits-02.png "Validation rule UI")
