...
[Suggest Edits](/edit/transfer-loyalty-points)
...
First, we need to call the [qualification endpoint](/reference/examine-vouchers-qualification). It returns a list of loyalty cards that can be used for redeeming a reward specified in the request.
...
POST: [https://api.voucherify.io/v1/loyalties/\{campaignId}/members/\{memberId}/transfers](https://api.voucherify.io/v1/loyalties/%7BcampaignId%7D/members/%7BmemberId%7D/transfers)
...
**Exemplary path:** [https://api.voucherify.io/v1/loyalties/camp\_qOrtQUT8sRZ0p6dEAkFpx97p/members/6PMax4A9/transfers](https://api.voucherify.io/v1/loyalties/camp_qOrtQUT8sRZ0p6dEAkFpx97p/members/6PMax4A9/transfers)
...
POST: [https://api.voucherify.io/v1/loyalties/\{campaignId}/members/\{memberId}/redemption](https://api.voucherify.io/v1/loyalties/%7BcampaignId%7D/members/%7BmemberId%7D/redemption)
...
* * [Reward qualification](#reward-qualification)
  * [Loyalty card validation](#loyalty-card-validation)
  * [The loyalty points transfer](#the-loyalty-points-transfer)
