...
<Update label="May 2026" description="Scheduled maintenance" rss={{ title: "Scheduled maintenance" }}>
...
- **EU1:** May 11, 18:00–19:30 CEST  

During each maintenance window, there will be a brief downtime period (~5–10 minutes). Requests made during this time may return **500 errors**.

Status pages:
- AS1: https://status.voucherify.io/incidents/tj3bj36zp12z  
- US1: https://status.voucherify.io/incidents/vwq5013p6p3v  
- EU1: https://status.voucherify.io/incidents/6yqhnr349f20  

</Update>

<Update label="23 Apr 2026" description="System security and permission improvements" rss={{ title: "System security and permission improvements" }}>
...
<Update label="22 Apr 2026" description="List customers in segment hotfix" rss={{ title: "List customers in segment hotfix"}}>
...
<Update label="21 Apr 2026" description="Mailchimp integration hotfix" rss={{ title: "Hotfix for Mailchimp integration"}}>
...
<Update label="03 Apr 2026" description="Campaign transfer and improved Braze integration" rss={{ title: "Campaign transfer and improved Braze integration" }}>
...
<Update label="15 Apr 2026" description="New discount effect for BOGO" rss={{ title: "New discount effect for BOGO" }}>
...
<Update label="2 Apr 2026" description="Product imports, voucher UI updates, and multiple fixes" rss={{ title: "Product imports, voucher UI updates, and multiple fixes" }}>
...
<Update label="31 Mar 2026" description="Fixes to products, promotions, and referral campaigns" rss={{ title: "Fixes to products, promotions, and referral campaigns"}}>
...
<Update label="26 Mar 2026" description="Roles and permissions hotfix" rss={{ title: "Hotfix for roles and permissions"}}>
...
<Update label="25 Mar 2026" description="Removed customer cockpits and landing pages" rss={{ title: "Removed cockpits and landing pages" }}>
...
Customer cockpits were removed. URLs to customer cockpits will redirect to dashboard Preference center, where customers can manage their email preferences. The updated URL is also returned by the [GET Get customer endpoint](/api-reference/customers/get-customer).
...
<Update label="24 Mar 2026" description="Redemptions hotfix" rss={{ title: "Hotfix for redemptions"}}>
...
<Update label="17 Mar 2026" description="Approval requests hotfix" rss={{ title: "Hotfix for approval requests"}}>
...
<Update label="17 Mar 2026" description="Improved Stacking Rules and Categories management" rss={{ title: "Improved Stacking Rules and Categories management"}}>
...
<Update label="12 Mar 2026" description="New validation rules and locale settings" rss={{ title: "New validation rules and locale settings"}}>
...
<Update label="9 Mar 2026" description="Custom webhook headers and UI improvements" rss={{ title: "Custom webhook headers"}}>
