...
- **Total amount after discounts**: The rule allows to block validation and redemption when the total amount is discounted beyond the defined value. For example, you can prevent orders from being discounted to \$0.
...
The API logs in the Audit log now provide improved information about used channels and endpoints for easier tracking how your API is accessed.
