...
## Fixed
- **Qualifications**: Fixed an issue that failed to return redeemables in campaigns with a validity time frame set with interval and duration, caused by daylight saving time changes.
