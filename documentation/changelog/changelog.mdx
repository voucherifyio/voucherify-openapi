...
Learn more about the `reward.redeemed` event in the [Events documentation](https://docs.voucherify.io/reference/events-customer-event-object#reward-redeemed).
