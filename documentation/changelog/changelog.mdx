...
<Update label="12 May 2026" description="Editing vouchers in referral and loyalty campaigns" rss={{ title: "Editing vouchers in referral and loyalty campaigns"}}>
...
<Update label="06 May 2026" description="Scheduling, stacking rules, and validation improvements" rss={{ title: "Scheduling, stacking rules, and validation improvements" }}>
