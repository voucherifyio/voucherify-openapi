...
<Update label="16 Mar 2026" description="Improved Stacking Rules and Categories management" rss={{ title: "Improved Stacking Rules and Categories management"}}>
...
<Note>
After deployment, users may need to log out and log back in for the new permissions to take effect.
</Note>
