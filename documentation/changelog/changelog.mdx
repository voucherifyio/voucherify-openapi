...
<Update label="13 Apr 2026" description="New discount effect for BOGO" rss={{ title: "New discount effect for BOGO" }}>
...
In the API, this effect is called `ADD_SAME_ITEMS` and it's found in `redeemables.result.discount.effect` field for validation and redemption endpoints.
