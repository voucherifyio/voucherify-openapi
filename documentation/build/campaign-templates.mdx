...
keywords: ['campaign templates', 'promotion tier templates', 'discount coupon templates', 'gift voucher templates', 'campaign configuration', 'template creation', 'project migration', 'validation rules', 'metadata schema', 'custom events', 'resource cloning', 'campaign builder']
---
...
- If it is different, a warning appears.

<Warning>
If the selected resource is different from the one saved in the template, a warning appears. However, you can still continue and create the campaign using the selected resource.
</Warning>
