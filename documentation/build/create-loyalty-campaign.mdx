...
<Step>
    ...
    4. (Optional) Set **New customers will auto-join campaign once any earning rule is fulfilled** for allowing customers to join the loyalty program when they meet the condition of an earning rule.
...
Tiers are optional membership levels of your loyalty campaign. Define loyalty tiers as follows.
    ...
    <Note>
        ...
        Read [Loyalty tiers](!!) to learn more about point and tier expiration.
...
Read [Getting started with distributions](!!) to learn more.
