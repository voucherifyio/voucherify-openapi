...
Tier levels are shared with the point-based path. Both count toward the same 100-tier limit, and each tier you create only appears in the path it was created under. A tier added here won't appear in **Tier levels point-base**, and vice versa.
