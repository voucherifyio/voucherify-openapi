...
The tier builder walks you through several steps. Each step controls a specific part of the configuration.

The panel on the left shows your progress and a summary of selected settings.

Some issues appear directly in the step where they occur, such as missing required fields or invalid tier ranges.

Some conflicts between steps may appear only after you save the tier structure as a draft.
