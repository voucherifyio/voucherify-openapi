...
keywords: ['gift card', 'code', 'import', 'CSV', 'generic gift card import']
---
...
export const DownloadLink = ({ url, filename, children }) => {
  ...
  return (
    <a href={url} onClick={handleDownload} style={{ cursor: 'pointer', fontWeight: 'bold' }}>
      {children}
    </a>
  );
};
...
Use these fields when importing **generic gift cards**. Generic gift cards are not assigned to a campaign and work independently.

Use the <DownloadLink url="https://raw.githubusercontent.com/voucherifyio/voucherify-openapi/refs/heads/master/documentation/examples/import-generic-gift-cards-template.csv" filename="import-generic-gift-cards-template.csv">CSV generic gift card file template</DownloadLink>.
...
These codes will function as generic gift cards, independent of a campaign. 
...
Use the <DownloadLink url="https://raw.githubusercontent.com/voucherifyio/voucherify-openapi/refs/heads/master/documentation/examples/import-gift-cards-into-campaign-template.csv" filename="import-gift-cards-into-campaign-template.csv">CSV gift card file template</DownloadLink>.
