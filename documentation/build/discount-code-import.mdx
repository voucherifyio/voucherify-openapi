...
keywords: ['discount', 'code', 'import', 'CSV', 'generic code import', 'coupon import']
---
...
Use these fields when importing **generic discount coupons**. Generic coupons are not assigned to a campaign and work independently.
...
These codes will function as generic discount coupons, independent of a campaign. 
