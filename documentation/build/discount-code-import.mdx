...
- **Value**  
  ...
  The meaning of this value depends on the selected discount type.
...
- **Metadata (custom attributes)**  
  Any additional columns mapped as metadata are stored as coupon metadata.  
...
- **Metadata (custom attributes)**  
  Additional data stored as coupon metadata.
