...
**Create tier** to configure rewards for referrers with **referral tiers**.
  ...
  - **Minimum unique referee redemptions** – reward the referrer after reaching a defined number of successful referrals. You can **Add filter** to create a customer segment that a referrer has to be included to be rewarded.
