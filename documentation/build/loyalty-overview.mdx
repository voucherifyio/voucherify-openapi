...
For developers and system integrators, see the [Loyalty v2 developer overview](/guides/loyalty-v2-overview), then [Integrate loyalty v2](/guides/loyalty-v2-integrate).
