...
You can add a reward to a:
- [Loyalty campaign](/build/loyalty-campaign-overview)
- [Referral campaign](/build/referral-program-overview)
...
- Referral campaign > Creater tier > Rewards step
...
**Points on loyalty card** reward add points to a customer's loyalty card. If a customer doesn't have a loyalty card yet, redeeming the reward automatically publishes a new loyalty card and adds points to it.
...
**Material rewards** are physical products from your catalog. [Upload your products](https://support.voucherify.io/article/52-product-management) to the dashboard before using them as rewards.
...
When a **Pay with points** reward is a added to loyalty campaign, you can limit its redemption with validation rules. These rules create limits based on customer, order, and metadata attributes.
