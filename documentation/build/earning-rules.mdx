...
[Validation rules](/personalize/validation-rules-reference) are additional conditions that the customer needs to meet to gain points with the earning rule.
