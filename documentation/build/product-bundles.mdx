...
<AccordionGroup>
  <Accordion title="Multiply discount by bundle count (default)">
    The discount scales automatically based on the number of bundles in the cart.
    ...
    **Example:**
    ...
    2 bundles → \$10 total discount  
  </Accordion>

  <Accordion title="Use custom formula (do not multiply automatically)">
