...
To create a new rule, click the plus button to open the [validation rule builder](create-validation-rules) in the Campaign Manager. You can also create validation rules in the [Validation Rules](https://support.voucherify.io/article/16-dashboard-sections#valrules) section in the dashboard for future use.
