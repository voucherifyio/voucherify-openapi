---
title: Tutorial – Create basic program
...
See [an interactive demo](https://app.demoboost.com/playback/bFOPIzGc?step=2 "Voucherify loyalty program designerdemo") of the loyalty program designer.

Read [Key concepts](/docs/loyalty/key-concepts) first to learn more about loyalty program components and how they work together.
...
To create your first loyalty program, go to **Loyalty hub** on the left side bar and click **Programs**. This opens the **Programs** page which lists all your programs and where you can create a new program by clicking **+ Create program**.
...
Once you've clicked **+ Create program**, name your wallet and save program draft.
...
<Tip>
    ...
    Learn what point wallets are and how they work in the [Key concepts](/build/key-concepts#point-wallet) page.
...
<Tip>
    ...
    Learn what earning rules are and how they work in the [Key concepts](/build/key-concepts#earning-rule) page.
...
1. Click **Review and launch** in the top of the screen.
...
4. Click **Launch** to activate the program. Once activated, you won't be able to add more point wallets or assign tier structures, but you still can add new earning rules or rewards.
...
Once the program is active, go to **Details** in the top of the screen to **Create member**. The create member window opens:
...
New members can be only added from existing Voucherify customers.
...
Click on the member ID to view the member details. The member details page shows the member's loyalty card, point balance, and other relevant information.

Click on the loyalty card ID to view the loyalty card details. The loyalty card details page shows the loyalty card's status, lifetime point breakdown, and other relevant information.
...
<Tip>
    ...
    Learn what program members are and how they work in the [Key concepts](/build/key-concepts#loyalty-member) page.
...
In the left side bar, go to **Campaign hub** > **Orders** to **Create order**. The create order builder opens.
...
<Steps>
  ...
  <Step title="View points earned">
    ...
    Go to **Loyalty hub** > **Programs** and click on you program. Go to **Details**, click on the member ID and you will see the points earned.

    Click on the loyalty card ID to view the loyalty card details. In the **Card transactions** tab, you can see the details of the particular transaction.

  </Step>

</Steps>

## Additional component: Rewards
...
5. Select a product or SKU from the list. Optionally, click the **+** button to create a new product or SKU.
...
<Tip>
    ...
    Learn what rewards are and how they work in the [Key concepts](/build/key-concepts#rewards) page.
