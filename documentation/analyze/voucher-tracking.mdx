...
description: "Track voucher activity and transactions for gift and loyalty cards"
keywords: ["voucher tracking", "gift card transactions", "loyalty card transactions", "voucher export"]
tag: "NEW"
---
...
The **Activity** tab in voucher details is a great tool for solving issues you have with voucher configuration, validation, and redemption. The events listed contain all data regarding changes to the campaign as well as the API request and reponse payloads of those changes.
