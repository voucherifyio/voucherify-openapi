...
<AccordionGroup>
  ...
  <Accordion title="Developer setup: Management API">
    ...
    Developers can manage areas and stores programmatically using the Management API (Enterprise feature). This includes creating, updating, and deleting areas and stores, as well as listing all areas and stores in a project.
