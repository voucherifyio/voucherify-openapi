...
<Info>
  ...
  If you aren't familiar with the structure or assignment rules or areas and stores in general, read the [Areas and stores reference guide](/path-to-reference) first.
