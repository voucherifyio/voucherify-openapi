...
<Note>
   ...
   However, if you combine several incentives belong to different categories with **Never stackable**, **Incentive application order** applies.
...
In this example, an single-use incentive is valid, but it produces no effect like the discount value is 0.
