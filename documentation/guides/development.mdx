...
6. **[SDKs](/guides/sdks)** and **[API reference](/reference/introduction-1)**: choose your software development kit to integrate faster with Voucherify or use the Voucherify endpoints directly.
7. **[Integration and connectors](/guides/integration-connectors)**: connect Voucherify with your CMS, CRM, CDP, CEP, distribution, or other platforms.
8. **[Webhooks](/guides/webhooks)**: learn more about using and configuring webhook notifications.
