...
The customer is given voucher codes using different methods. You can use [Voucherify's Distributions](/guides/distributions) or a standalone voucher that the customer received in many different ways.
