...
description: "Integrate Voucherify with your system and apply different scenarios"
---

[Suggest Edits](/edit/integration-processes)
...
* **[Qualification](/reference/check-eligibility)** – occasionally, you may want your customers see vouchers, promotions, and campaigns they qualify for, based on customer attributes and the current contents of their shopping cart. Voucherify's Qualifications API suggests relevant promotions and coupons within the specific customer and order context and offers filtering options based on campaign category and hierarchy.

* **[Publication](/reference/create-publication)** – it involves associating a code with a specific customer. Typically, code distribution occurs through publications to your customers. Once the code is delivered to a customer, it becomes visible in their profile in Voucherify.

* **[Validation](/reference/validate-stacked-discounts)** – it verifies the eligibility of the selected discounts and calculates the final price.

* **[Redemption](/reference/redeem-stacked-discounts)** – it redeems a combination of vouchers, promotion tiers, and promotion stacks.
...
The customer is given voucher codes using different methods. You can use [Voucherify's Distributions](/docs/distributions) or a standalone voucher that the customer received in many different ways.

![Distributions in Voucherify](/images/docs/8236eff-guides_implementation_blueprint_integration_processes_distributions.png "Distributions in Voucherify")
...
![Customer experience in Voucherify](/images/docs/1ee38e4-guides_development_integration_processes_customer_experience_case_1.png "Customer experience in Voucherify")
...
![Customer experience in Voucherify case 2](/images/docs/3718f77-guides_development_integration_processes_customer_experience_case_2a.png "Customer experience in Voucherify case 2")
...
![Customer experience in Voucherify case 3](/images/docs/0729f90-guides_development_integration_processes_customer_experience_case_3a.png "Customer experience in Voucherify case 3")
...
![Customer experience in Voucherify case 4](/images/docs/334ae9f-guides_development_integration_processes_customer_experience_case_4.png "Customer experience in Voucherify case 4")
...
* * [Introduction](#introduction)
  ...
  * [Use cases](#use-cases)
    ...
    * [Redeeming voucher codes](#redeeming-voucher-codes)
    * [Checking promotion (discount without a code) eligibility during checkout](#checking-promotion-discount-without-a-code-eligibility-during-checkout)
    * [Publishing a voucher code in a wandering customer scenario](#publishing-a-voucher-code-in-a-wandering-customer-scenario)
    * [Rewarding customers with points for purchases.](#rewarding-customers-with-points-for-purchases)
