...
The customer is given voucher codes using different methods. You can use [Voucherify's Distributions](/integrations/distributions-overview) or a generic voucher that the customer received in many different ways.
