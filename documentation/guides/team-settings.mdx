...
- [Manage Voucherify account](/manage/manage-voucherify-account) to learn more about managing your subscription.
...
You can add as many projects up to your subscription limit. The Sandbox project is not counted towards the project limit.
...
In the **Roles** tab, you can review role permissions and manage custom roles (enterprise feature).

<Info>

Read [Manage members and roles](/manage/manage-members-and-roles) to learn more about built-in and custom roles.
...
To completely delete customer data, you need to provide their customer ID assigned by Voucherify in the **Delete people data** tab. You can find this way the deleted customer profile and delete their data permanently.
...
In the **Management API** tab, you can define and manage API keys that allow you creating and managing projects through the API.
...
Go to **Home** > **Project settings** in the left-bar menu to configure project-level options such as API keys, webhooks, currency, metadata and custom event schemas, and check usage.
