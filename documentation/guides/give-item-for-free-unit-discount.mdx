...
<Note>
  There are many attributes and details you can customize while creating a campaign (start and expiration date, validation rules, and many more). If you're not familiar with all the options, please visit [this guide](/build/create-discount-coupons) first.
</Note>
