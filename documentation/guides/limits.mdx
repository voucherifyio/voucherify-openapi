...
keywords: ['summary', 'limits', 'optimization', 'buy API calls', 'API package']
---
...
If you expect to use more API calls than your usual limit, you can [purchase extra packages](/limits#buying-additional-api-packages "Buying additional API call packages") to raise those limits. This lets you temporarily increase the number of API calls you can make per hour, per minute, or per cycle, providing a boost when needed.
