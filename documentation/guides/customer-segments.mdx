...
<Steps>
  ...
  <Step title="Select customers">
    ...
    Check the customer's checkboxes. You can search for specific customers or use filters to to narrow down the results.
...
<AccordionGroup>
  ...
  <Accordion title="Customer data">
    ...
    Read [Manage customer profiles](/prepare/customers) how-to guide to learn more about adding and updating customers.
  ...
  <Accordion title="Use segments in earning rules">
    ...
    Segments can be used in [loyalty campaign earning rules](/build/earning-rules)
