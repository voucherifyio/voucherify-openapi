...
Use this page to secure your campaigns from fraud, define specific buying conditions, and control how and when customers can redeem incentives or earn loyalty points.
...
- **Redeeming code holder**: Restrict redemptions to the customer the code was published to.
...
- **Order metadata**: Require specific metadata to be present un the order.
