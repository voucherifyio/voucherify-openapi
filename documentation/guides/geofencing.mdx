...
import MetadataNote from '/snippets/callouts/note-metadata.mdx'
...
<AccordionGroup>
  ...
  <Accordion title="Customer segments">
    ...
    Use customer segments to group customers by location. Create a segment based on geopoint metadata and a location object, then use it in validation rules to control who can redeem.
  ...
  <Accordion title="Product collections">
    ...
    Use product collections to group products or SKUs by location. Create a dynamic collection based on geopoint metadata and a location object, then use it in validation rules to control which items are eligible.
  ...
  <Accordion title="Validation rules">
    ...
    Use validation rules to apply location-based segments and collections to your campaigns. You can require customers from a specific segment, or check whether order items belong to a location-based collection.
  ...
  <Accordion title="Developer setup: Geofencing API">
    ...
    - **Redemptions**: Send customer or product geopoint metadata in the [Redeem Stacked Discounts](/api-reference/redemptions/redeem-stackable-discounts) or [Redeem Voucher](/api-reference/redemptions/redeem-voucher) request body to trigger location-based validation.
    ...
    - **Metadata schemas**: Define geopoint metadata fields using the [Metadata Schemas API](/api-reference/metadata-schemas/metadata-schema-object).
