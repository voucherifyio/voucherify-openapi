...
<Info>
      ...
      Customer geofencing works only if the customer’s current location is sent during redemption in customer metadata. If no data is sent, the customer will not match any location-based segment.
      
      Customer metadata and their current location in redemption is set up by a developer.
...
<Steps>
  ...
  <Step title="Create a location-based customer segment">
    ...
    Read the [Customer segments](/prepare/customer-segments) article to learn more.
  ...
  <Step title="Add a validation rule">
    ...
    Read the [Create validation rules](/optimize/create-validation-rules) article to learn more.
...
<Info>
      ...
      Product and SKU geofencing works only if the product's or SKU's current location is sent during redemption as item metadata. If no data is sent, the item will not match any location-based collections.
      
      Item metadata and their current location in redemption is set up by a developer.
...
<Steps>
  ...
  <Step title="Create a location-based product collection">
      ...
      Read the [Product collections](/optimize/product-collections) article to learn more.
