...
keywords: ['incentive', 'channel', 'publication', 'messaging', 'integration']
...
<Note>
  Publication means incentive assignment. Typically, a publication is performed by sharing codes with customers [via Publication API](/api-reference/publications/publication-object).
</Note>
