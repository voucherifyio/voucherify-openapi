...
| CAMPAIGN.VOUCHERS\_GENERATE                                                                                                                       | * **POST** [/campaigns](/api-reference/campaigns/create-campaign): asynchronous for campaigns with more than 1 voucher, synchronous for campaign with 1 voucher <br />* **POST** [/campaigns/\{campaignId}/vouchers](/reference/add-vouchers-to-campaign)>
 |
| **CUSTOMERS**                                                                                                                                     |                                                                                                                                                                                                                                        |
