...
tag: NEW
keywords: ['new', 'documentation', 'explore', 'interactive']
---
...
<Warning>
URLs of pages in **Guides** and **API reference** have changed. We've set redirects for you, so your bookmarks could still work, but some pages may return 404. Use search bar to quickly find what you need!
</Warning>
...
Currently, the API playground doesn't prefill your API keys when you log in. We're working on a fix.

Please manually copy your Sandbox API keys from the Project settings in Voucherify dashboard to the playground fields after logging in.
