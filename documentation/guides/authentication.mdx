...
<Note>
  In addition to the keys, you will need to choose suitable [API endpoints](/guides/introduction-api).
</Note>
...
* [commercetools](https://support.voucherify.io/article/581-commercetools "commercetools integrations")
