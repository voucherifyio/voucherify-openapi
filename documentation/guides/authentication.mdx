...
<Note>
  In addition to the keys, you will need to choose the [API region endpoint](/guides/api-overview#choose-the-right-api-endpoint) your project is bound to, for example `https://us1.api.voucherify.io`.
</Note>
