...
| **Endpoint**                           | **Link**                                                                                      |
| -------------------------------------- | --------------------------------------------------------------------------------------------- |
| **POST** `v1/v1/qualifications`        | Check eligibility using the [server-side endpoint](/api-reference/qualifications/check-eligibility).             |
| **POST** `v1/client/v1/qualifications` | Check eligibility using the [client-side endpoint](/api-reference/client-side/check-eligibility-client-side). |
