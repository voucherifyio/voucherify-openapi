...
To specify the types of promotions and codes that you want to reveal to your customers, you can include a scenario. A scenario defines the type of content to return from all the available campaigns and generic codes that you created in Voucherify.
