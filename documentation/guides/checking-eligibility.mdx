...
Voucherify's [Qualifications API](/reference/check-eligibility) helps recommend applicable promotions and coupons in the given customer and order context with filtering options based on campaign category and hierarchy.
...
| **Endpoint**                           | **Link**                                                                                      |
| -------------------------------------- | --------------------------------------------------------------------------------------------- |
| **POST** `v1/v1/qualifications`        | Check eligibility using the [server-side endpoint](/reference/check-eligibility).             |
| **POST** `v1/client/v1/qualifications` | Check eligibility using the [client-side endpoint](/reference/check-eligibility-client-side). |

You can find a description of the qualification object schema in the data model description [here](/reference/qualification-object).
...
In the request, you can add [options](/reference/check-eligibility) to configure the parameters returned in the response, e.g. filters for types of redeemables or sorting rules like `BEST_DEAL` or `LEAST_DEAL`.
...
![Promotions Available for non-logged in customers](/images/docs/3dedd4a-campaign_recipes_qualification_checking_eligibility_availableOffersNotLoggedIn.png "Promotions Available for non-logged in customers")
...
![Offers Available for logged in customers](/images/docs/fff83fa-campaign_recipes_qualification_checking_eligibility_availableOffersLoggedIn.png "Offers Available for logged in customers")
...
![Product Catalog Coupon](/images/docs/be0044a-campaign_recipes_qualification_checking_eligibility_myCoupons.png "Product Catalog Coupon")
...
![Product Coupons In Cart](/images/docs/dfd3e1f-campaign_recipes_qualification_checking_eligibility_productCouponsInCart.png "Product Coupons In Cart")
...
![Upselling](/images/docs/accc476-guides_campaign_recipes_qualification_checking_eligibility_upselling.png "Upselling")
...
* * [Overview](#overview)
  ...
  * [Use Cases](#use-cases)
    ...
    * [Case 1 - Logged in vs non-logged in customers](#case-1---logged-in-vs-non-logged-in-customers)
    * [Case 2 - Vouchers assigned to customer](#case-2---vouchers-assigned-to-customer)
    * [Case 3 - Vouchers applicable to specific products](#case-3---vouchers-applicable-to-specific-products)
    * [Case 4 - Upselling (audience only)](#case-4---upselling-audience-only)
    * [Bundles](#bundles)
