...
The dynamic formula builder allows you to create mathematical and logical expressions to calculate discount values or loyalty points in real time. Instead of using a static value, Voucherify evaluates the formula during redemption based on available system data and metadata.
...
Evaluates a value against multiple cases.
