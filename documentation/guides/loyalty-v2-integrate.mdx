...
For a map of the `/v2/loyalties` API surface, core identifiers, and how this guide fits with the rest of the docs, start with the [Loyalty v2 developer overview](/guides/loyalty-v2-overview).
