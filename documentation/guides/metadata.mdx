...
Metadata in Voucherify is custom key–value data you add to objects (customers, orders, products, campaigns) to control targeting, personalize incentives, and improve tracking and reporting.
...
To learn more about metadata, see the [Metadata mapping](/guides/metadata-mapping) article.
...
| Type | Details |
| :--- | :--- |
| **String** | Supports criteria: min/max/exact length, equal to any of. |
...
Be careful when you mark metadata as **required**.

If you make many fields **required** and you do not send them in your payload, Voucherify rejects the request with a validation error.
