...
keywords: ['SDK', 'widget', 'client-side', 'enable']
---
...
* `subscribe widget` which adds a [customer](/api-reference/customers/get-customer) to Voucherify. You can then use one of the automatic delivery channels to send them a coupon. [Read more here](https://voucherifyio.github.io/voucherify-js-sdk/#client-side-methods).
