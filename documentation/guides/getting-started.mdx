...
2. Go to [Validate stackable discounts](/reference/validate-stacked-discounts).
...
* * [Creating an account](#creating-an-account)
  ...
  * [Voucherify API Postman collection](#voucherify-api-postman-collection)

  * [Managing roles and inviting users](#managing-roles-and-inviting-users)

  * [Exploring the Voucherify API in the Sandbox project](#exploring-the-voucherify-api-in-the-sandbox-project)
