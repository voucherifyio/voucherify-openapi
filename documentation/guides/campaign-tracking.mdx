...
Each campaign type offers a dedicated dashboard and supporting tabs that help you monitor performance, usage, and configuration details. The available data depends on the campaign type.
...
- **Redemption values**: A summary of promotion tiers with their discount values and application scope.
- **Total orders value and total discounted amount**: Metrics shown for each promotion tier in the selected period.
