...
[Suggest Edits](/edit/api-optimization)
...
<Info>
  Webhooks use separate limits and do not count towards the API call limits. Learn more in our [Limits](/docs/limits) article.
</Info>
...
* * [API call optimization](#api-call-optimization)
    ...
    * [Revising integrated processes](#revising-integrated-processes)
    * [Revising data synchronization between the systems](#revising-data-synchronization-between-the-systems)
    * [Synchronizing data via Webhooks](#synchronizing-data-via-webhooks)
