...
- `POINTS_EXPIRED`: Points that expired under the point wallet settings.
...
```json Example: List card transactions response wrap expandable lines highlight={11-24,38-47,89}
{
    "data": [
        {
...
Use the GET List reward purchases (`v2/loyalties/programs/{programId}/members/{memberId}/rewards/purchases`) endpoint to show your members the rewards they have purchased. This endpoint lists purchases for all cards 
