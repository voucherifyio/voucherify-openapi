...
description: "The discount effect defines how the discount will be applied to the customer's cart. In this article, we're going to show you how different effects work with discounts."
---

[Suggest Edits](/edit/discount-effects)
...
**Step 1: Create validation rules** [Create Validation Rules](/reference/create-validation-rules) to define discounted items as [described here](/docs/discount-effects#step-1-create-validation-rules).
...
**Step 3: Assign validation rules** [Create Validation Rules Assignment](/reference/create-validation-rule-assignment) to attach validation rule with discounted products to the created discount.
...
– If a customer doesn't have the t-shirt already in the cart, then a free t-shirt will be added to the order. – If a customer already has this item in the cart, then the number of t-shirts already matches the units count. As a result, after applying the code, a discount will be applied to the item which is already in the cart and no extra items will be added. [Read more](/docs/give-item-for-free-unit-discount#redemption-of-the-code-with-discount-effect-add_missing_items).
...
Choosing this effect results in adding items to the cart in the number defined by unit value. For example, if the code gives one free t-shirt, then no matter if a customer has the t-shirt already in the cart or not, a free t-shirt will always be added to the order and discounted. [Read more](/docs/give-item-for-free-unit-discount#redemption-of-the-code-with-discount-effect-add_new_items).
...
The discount gives multiple types of free item(s) to customers. Free item units are always added to the customer's cart based on either the **Add missing items** or **Add new order items** effects. [Read more](/docs/give-item-for-free-unit-discount#redemption-of-the-code-with-discount-effect-add_many_items).
...
Discount effects work in parallel with the remaining [Validation rules](/docs/validation-rules) that specify included and excluded items, required cart structure and other redemption circumstances.

***

* [Table of Contents](#)

* * [Apply to Order](#apply-to-order)
  * [Apply to Items](#apply-to-items)
  * [Apply to Items Proportionally](#apply-to-items-proportionally)
  * [Apply to Items Proportionally by Quantity](#apply-to-items-proportionally-by-quantity)
  * [Apply to Items to each unit of matched product](#apply-to-items-to-each-unit-of-matched-product)
  * [Add Missing Items](#add-missing-items)
  * [Add New Items](#add-new-items)
  * [Add Many Items](#add-many-items)
  * [Default Effect](#default-effect)
  * [Effects and Validation Rules](#effects-and-validation-rules)
