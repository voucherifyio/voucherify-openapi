...
* **Status**: The current state of the order:
  ...
  * **Order canceled**: The order was cancelled. Using **redemption rollback** automatically switches a status from *paid* to *canceled*.
...
<Steps>
  ...
  <Step title="Select field data">
    ...
    Select fields to export specific data.
...
<AccordionGroup>
  ...
  * **Loyal buyers**: Customers who have reached a specific number of orders.
  ...
  You can use those segments then for [distributions](https://support.voucherify.io/article/19-how-does-the-distribution-manager-work) or [validation rules](https://support.voucherify.io/article/529-validation-rules-campaign-limits).
