...
* Generic vouchers: [JSON](/api-reference/vouchers/import-vouchers), [CSV](/api-reference/vouchers/import-vouchers-using-csv).
...
<Note>
  ...
  * [Import generic vouchers with JSON](https://www.postman.com/voucherify/voucherify-s-public-workspace/request/u2cln3f/import-vouchers?tab=overview)
  * [Import generic vouchers with CSV](https://www.postman.com/voucherify/voucherify-s-public-workspace/request/z9qk64n/import-vouchers-using-csv)
