...
* Generic (standalone) vouchers: [JSON](/reference/import-vouchers), [CSV](/reference/import-vouchers-using-csv).
* Vouchers assigned to a given campaign: [JSON](/reference/import-vouchers-to-campaign), [CSV](/reference/import-vouchers-to-campaign-using-csv).
...
* * [Programmable import through the API](#programmable-import-through-the-api)
  * [Dashboard import tool mode](#dashboard-import-tool-mode)
