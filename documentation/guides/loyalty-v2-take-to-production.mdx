...
- For incorrect reward purchases, use [Refund a reward purchase](/api-reference/programs/refund-reward-purchase) when your support process allows refunds. Confirm the refund flow in Sandbox before production use.
