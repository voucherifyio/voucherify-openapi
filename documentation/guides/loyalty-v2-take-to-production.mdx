...
Once your integration is ready as described in [Integrate loyalty v2](/guides/loyalty-v2-integrate), you can prepare your environment for a successful launch. For orientation on objects, IDs, and the API surface, see the [Loyalty v2 developer overview](/guides/loyalty-v2-overview).
