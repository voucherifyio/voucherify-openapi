...
- To stop a member from earning or spending, [deactivate the member](/api-reference/programs/deactivate-a-program-member). To pause the whole program, deactivate the program in **Loyalty hub** after you understand the impact on active members.
