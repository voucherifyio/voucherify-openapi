---
title: "Audit log"
description: "Learn what audit log is, what data it includes, and how to use it in Voucherify"
keywords: ['audit logs', 'logs', 'monitoring', 'troubleshooting', 'debugging', 'API log', 'webhook logs']
tag: "NEW"
---
...
Use **Background tasks** to monitor long-running operations such as imports, exports, or campaign updates. **Background tasks** list asynchronous actions triggered from the API as well. You can see if the task is enqueued, in progress, done, or failed.
