...
Your API version controls the API and webhook behavior you see (e.g., what properties you see in responses, what parameters you’re permitted to send in requests, etc.). Your version is set the first time you make an API request. When we make a backwards-incompatible change, we release a new dated version. To avoid breaking your code, we don’t change your version until you’re ready to upgrade.
