...
<div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(80px,1fr))',gap:'1rem',alignItems:'center',justifyItems:'center'}}>
  ...
  <a href="https://github.com/rspective/voucherify-php-sdk" target="_blank" aria-label="Voucherify PHP SDK" title="PHP SDK">
...
[rspective/voucherify.js](https://github.com/voucherifyio/voucherify.js)
